<template>
    ...
    >
        <div
            class="bg-gray-200 flex flex-col rounded-xl lg:flex-row "
        >
        <div>
            <button 
                @click="closeModal"
            ...
            <div class="flex flex-col p-4 gap-4 bg-gray-900 text-gray-100 ">
                <div class="flex gap-4 items-center md:justify-evenly">
                    ...
                    <p class="p-2 text-xl sm:text-3xl bg-gray-200 text-gray-900 rounded-full">
                        {{ pokemon.id }}
                    </p>
                </div>

                <div class="flex flex-col gap-2 p-2 text-center rounded-lg bg-gray-200 text-gray-900">
                ...
                <div class="grid grid-cols-3 sm:grid-cols-2 gap-2">
                    ...
                    >
                         <div class="flex flex-col bg-gray-200 text-gray-900 rounded-lg p-2 items-center">

                            <p class="text-sm sm:text-xl border-2 border-black text-center w-10 h-10 p-1 rounded-full">
                                {{ stat.base_stat }}
                            </p>
